# REP-3011: WAVE — A Peer-to-Peer Radiant Blockchain Name System
...
- **Protocol ID**: GLYPH_WAVE = 11
- **Reference Implementation**: Photonic Wallet
- **Features**: Name registration, resolution, zone records, subdomain delegation
- **Mutable Metadata**: Zone records updatable via controller
...
├── Output 0: Claim Token (empty name "")
├── Output 1: 'a' branch
├── Output 2: 'b' branch
├── ...
├── Output 26: 'z' branch
...
'a' branch spend:
├── Output 0: Claim Token for "a"
├── Output 1: 'a' branch → "aa"
├── Output 2: 'b' branch → "ab"
├── ...
└── Output 37: '-' branch → "a-"
```
...
- Display Claim Tokens as standard NFTs ✓
- Allow transfers ✓
- Not understand zone records ✗
- Not resolve names ✗
...
**Resolution**:
1. Resolve `alice` → get alice's Claim Token
