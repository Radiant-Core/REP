...
- **Design**: Complete specification with X25519+HKDF+AES-GCM
- **Dependencies**: REP-3006 (encryption layer)
- **Primitives Required**: X25519 key agreement, HKDF-SHA256, AES-256-GCM
- **Estimated Effort**: 1-2 weeks (can be done with REP-3006)
...
- Alternative key agreement (secp256k1 ECIES) — reserved for future REP
