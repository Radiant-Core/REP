...
- **Reference Implementation**: Photonic Wallet, RXinDexer
- **Activation Height**: Block 410,000 (V2 hard fork)
- **Test Coverage**: 82/82 tests passing in Photonic Wallet, 125/125 in Glyph Miner
- **Whitepaper**: Glyph_v2_Token_Standard_Whitepaper.md (draft-9)
