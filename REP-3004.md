...
- **Reference Implementation**: RXinDexer (electrumx/server/glyph_index.py)
- **Database Schema**: Tables for glyphs, files, updates, rels, key_reveals as specified
- **Reorg Handling**: Full rollback and re-scan capability
- **API Endpoints**: REST API for glyph queries
- **Test Coverage**: test_glyph_index.py, test_api_comprehensive.py
